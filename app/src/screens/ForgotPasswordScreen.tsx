...
const styles = StyleSheet.create({
  ...
  stepDot: { width: 32, height: 6, borderRadius: 3, backgroundColor: '#E2E9F0' },
  stepDotOn: { backgroundColor: colors.primary },
  label: { color: '#1A2B4A', fontSize: 16, fontWeight: '800', marginTop: 6 },
  pill: { flexDirection: 'row', alignItems: 'center', height: 56, borderRadius: 28, borderWidth: 1.5, borderColor: '#E6EDF3', paddingHorizontal: 18, gap: 12, shadowColor: '#0A3A5A', shadowOpacity: 0.08, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
